...
function GetInTouch() {
  ...
  return (
    ...
    <HelmetProvider>
      ...
      <section className="section-gitouch w-full xl:px-0 px-4">
          <div className="xl:container mx-auto">
            <div className="gitouch-content_wrapper p-[2.5rem_0_6.25rem] w-full max-w-[71.25rem] mx-auto">
              <div className="gitouch-form flex flex-wrap gap-[1.688rem]">
                <div className="gitouch-start_content w-full max-w-[26.938rem] flex flex-col  gap-[2.438rem]">
                  ...
                  <div className="detail_gitouch-start flex flex-col gap-[1.313rem]">
                    ...
                    <div className="flex flex-col gap-[0.688rem]">
                      <div className="flex flex-nowrap gap-[0.625rem]"><img src="" alt="icon" /><p className="font-semibold">we will respond to you in 24 hours</p></div>
                      <div className="flex flex-nowrap gap-[0.625rem]"><img src="" alt="icon" /><p className="font-semibold">we are open for discussion regarding your business</p></div>
                    </div>
                  </div>
                </div>
                <div className="gitouch-end_content w-full max-w-[34.25rem] flex flex-col  gap-[]">
      ...
      <section className="section-faq w-full xl:px-0 px-4">
          <div className="xl:container mx-auto">
            <div className="faq-content_wrapper flex flex-col gap-[4.375rem] mx-auto w-full max-w-[72rem]">
              ...
              <div className="faq-end_content flex flex-wrap gap-[4rem]">
                <div className="flex flex-col gap-[2.5rem] w-full max-w-[19.25rem] mx-auto">
                  <div className="flex flex-col gap-[1.25rem]">
                    ...
                    <div className="flex flex-wrap gap-[1.563rem]">
                      <div className="w-[4.188rem] h-[4.188rem] rounded-full overflow-hidden border-[0.25rem] border-[#144688]"><img src="" alt="human img" /></div>
                  ...
                  <Button btn="btn2" className='btn-primary-smc ms-auto'>Ask a Quetion  <img src={sendIcon} alt="" /></Button>
                </div>
                <div className="flex flex-col gap-[2.5rem] w-full max-w-[26.875rem] mx-auto">
                  <Faq faqItems={faq}/>
                </div>
              </div>
            </div>
